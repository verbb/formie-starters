import type { FrontendFormEnvelope } from "@verbb/formie-react";
...
function toServerRenderPayloadInput(input: Record<string, unknown>): Record<string, unknown> {
  ...
  (["theme", "themeConfig", "locale", "siteId"] as const).forEach((key) => {
...
export async function requestGraphqlDefinitionEnvelopeResponse(
  graphqlEndpoint: string,
  handle: string,
): Promise<GraphqlEnvelopeResponse> {
