...
export const REST_SCENARIOS: RestScenario[] = [
  ...
  },
  {
    ...
    summary: 'Load the public component contract and render it with a minimal app-owned Vue view.',
    description: 'This path is intentionally small and contract-focused because the host app owns the markup and styling surface.',
  },
];
...
export const GRAPHQL_DEMOS: GraphqlDemo[] = [
  ...
  },
  {
    ...
    summary: 'Fetch the dedicated frontend contract through GraphQL and map it into a minimal Vue renderer.',
    description: 'Use this to inspect the canonical `formieClientForm` envelope a GraphQL-first app can map into its own rendering layer.',
  },
  {
    id: 'submit-mutation',
    mode: 'client-rendered',
    ...
    description: 'This is the clearest follow-along example for teams posting component-mode submissions through the dedicated frontend contract mutation surface.',
  },
];
